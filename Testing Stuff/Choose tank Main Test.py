...
def create_second_window():
    ...
    # Create an OptionMenu for the Nation
    ...
    # Create a label and OptionMenu for the tank
    ...
    with open(f'{WT_directory}\\Testing Stuff\\ask3lad_testdrive.blk', 'r') as f:
        lines = f.readlines()
    ...
    def take_input():
        if selected_Tank.get() == selected_TankDefault or selected_Tank.get() == '':
            ...
            with open(f'{WT_directory}\\Testing Stuff\\ask3lad_testdrive.blk', 'w') as f:
                f.writelines(lines)
            print(lines[171])
            lines[1] = 'include "#/develop/gameBase/gameData/units/tankModels/{}_{}.blk"'.format(selected_Nation.get(), selected_Tank.get())
            with open(f'{WT_directory}\\Testing Stuff\\us_m2a4.blk', 'w') as f:
